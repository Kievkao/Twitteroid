...
@interface TWRUserProfileStorage()

@end

@implementation TWRUserProfileStorage
...
- (void)setUserAvatarByURL:(NSURL *)url completion:(void (^)(NSError *error))completion {
